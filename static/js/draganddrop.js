...
function comprobarPuzzle(){
    if((document.getElementById('pieza6').parentNode.id=='uno') &&
        (document.getElementById('pieza4').parentNode.id=='dos') &&
        (document.getElementById('pieza1').parentNode.id=='tres') &&
        (document.getElementById('pieza3').parentNode.id=='cuatro') &&
        (document.getElementById('pieza9').parentNode.id=='cinco') &&
        (document.getElementById('pieza2').parentNode.id=='seis') &&
        (document.getElementById('pieza8').parentNode.id=='siete') &&
        (document.getElementById('pieza7').parentNode.id=='ocho') &&
        (document.getElementById('pieza5').parentNode.id=='nueve'))
    {
